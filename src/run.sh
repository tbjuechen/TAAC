...
# 长序列 (W1.7-L2):  SEQ_ENCODER_TYPE=longer GATHER_SIDE=head SEQ_TRUNCATE='seq_a:256,seq_b:256,seq_c:512,seq_d:2048' ./run.sh
SEQ_ENCODER_TYPE="${SEQ_ENCODER_TYPE:-transformer}"
GATHER_SIDE="${GATHER_SIDE:-head}"
SEQ_TOP_K="${SEQ_TOP_K:-50}"
SEQ_TRUNCATE="${SEQ_TRUNCATE:-seq_a:256,seq_b:256,seq_c:512,seq_d:512}"
# ============================================================
