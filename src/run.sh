...
USE_DIN="${USE_DIN:-0}"
DIN_ATTENTION_DROPOUT_RATE="${DIN_ATTENTION_DROPOUT_RATE:-0.0}"
...
echo "[run.sh] USE_DIN=${USE_DIN}"
echo "[run.sh] DIN_ATTENTION_DROPOUT_RATE=${DIN_ATTENTION_DROPOUT_RATE}"
...
[ "${USE_DIN}" = "1" ] && EXTRA_FLAGS="${EXTRA_FLAGS} --use_din"
[ "${DIN_ATTENTION_DROPOUT_RATE}" != "0" ] && [ "${DIN_ATTENTION_DROPOUT_RATE}" != "0.0" ] && EXTRA_FLAGS="${EXTRA_FLAGS} --din_attention_dropout_rate ${DIN_ATTENTION_DROPOUT_RATE}"
