...
SEQ_SEMILOCAL_CAUSAL="${SEQ_SEMILOCAL_CAUSAL:-1}"
SEQ_SEMILOCAL_RECENT_WINDOW="${SEQ_SEMILOCAL_RECENT_WINDOW:-128}"
SEQ_SEMILOCAL_OLD_STRIDE="${SEQ_SEMILOCAL_OLD_STRIDE:-16}"
...
echo "[run.sh] SEQ_SEMILOCAL_CAUSAL=${SEQ_SEMILOCAL_CAUSAL}"
echo "[run.sh] SEQ_SEMILOCAL_RECENT_WINDOW=${SEQ_SEMILOCAL_RECENT_WINDOW}"
echo "[run.sh] SEQ_SEMILOCAL_OLD_STRIDE=${SEQ_SEMILOCAL_OLD_STRIDE}"
...
[ "${SEQ_SEMILOCAL_CAUSAL}" = "1" ] && EXTRA_FLAGS="${EXTRA_FLAGS} --seq_semilocal_causal"
EXTRA_FLAGS="${EXTRA_FLAGS} --seq_semilocal_recent_window ${SEQ_SEMILOCAL_RECENT_WINDOW}"
EXTRA_FLAGS="${EXTRA_FLAGS} --seq_semilocal_old_stride ${SEQ_SEMILOCAL_OLD_STRIDE}"
